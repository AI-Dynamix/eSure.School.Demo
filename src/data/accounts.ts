...
export const accountsReceivable: AccountRecord[] = [
  ...
  { id: 'AR-2024-11-VNPT', type: 'AR', partnerId: 'VNPT', partnerName: 'VNPT VneDu', period: 'T11/24', transactionCount: 8250, grossAmount: 2_887_500_000, netAmount: 2_858_625_000, paidAmount: 2_858_625_000, remainingAmount: 0, dueDate: '2024-12-20', status: 'paid', createdAt: '2024-12-01' },
  { id: 'AR-2024-12-VNPT', type: 'AR', partnerId: 'VNPT', partnerName: 'VNPT VneDu', period: 'T12/24', transactionCount: 5850, grossAmount: 2_047_500_000, netAmount: 2_027_025_000, paidAmount: 0, remainingAmount: 2_027_025_000, dueDate: '2025-01-20', status: 'pending', createdAt: '2025-01-01' },
  ...
  { id: 'AR-2024-10-VNPT', type: 'AR', partnerId: 'VNPT', partnerName: 'VNPT VneDu', period: 'T10/24', transactionCount: 9850, grossAmount: 3_447_500_000, netAmount: 3_413_025_000, paidAmount: 3_413_025_000, remainingAmount: 0, dueDate: '2024-11-20', status: 'paid', createdAt: '2024-11-01' },
  ...
  { id: 'AR-2024-09-VNPT', type: 'AR', partnerId: 'VNPT', partnerName: 'VNPT VneDu', period: 'T09/24', transactionCount: 12500, grossAmount: 4_375_000_000, netAmount: 4_331_250_000, paidAmount: 4_331_250_000, remainingAmount: 0, dueDate: '2024-10-20', status: 'paid', createdAt: '2024-10-01' },
]
...
export const accountsPayableCommission: AccountRecord[] = [
  ...
  { id: 'AP-2024-11-VNPT-COMM', type: 'AP_COMMISSION', partnerId: 'VNPT', partnerName: 'VNPT VneDu', period: 'T11/24', transactionCount: 8250, grossAmount: 2_887_500_000, netAmount: 173_250_000, paidAmount: 173_250_000, remainingAmount: 0, dueDate: '2024-12-20', status: 'paid', createdAt: '2024-12-01' },
  { id: 'AP-2024-12-VNPT-COMM', type: 'AP_COMMISSION', partnerId: 'VNPT', partnerName: 'VNPT VneDu', period: 'T12/24', transactionCount: 5850, grossAmount: 2_047_500_000, netAmount: 122_850_000, paidAmount: 0, remainingAmount: 122_850_000, dueDate: '2025-01-20', status: 'pending', createdAt: '2025-01-01' },
  ...
  { id: 'AP-2024-10-VNPT-COMM', type: 'AP_COMMISSION', partnerId: 'VNPT', partnerName: 'VNPT VneDu', period: 'T10/24', transactionCount: 9850, grossAmount: 3_447_500_000, netAmount: 206_850_000, paidAmount: 206_850_000, remainingAmount: 0, dueDate: '2024-11-20', status: 'paid', createdAt: '2024-11-01' },
  ...
  { id: 'AP-2024-09-VNPT-COMM', type: 'AP_COMMISSION', partnerId: 'VNPT', partnerName: 'VNPT VneDu', period: 'T09/24', transactionCount: 12500, grossAmount: 4_375_000_000, netAmount: 262_500_000, paidAmount: 262_500_000, remainingAmount: 0, dueDate: '2024-10-20', status: 'paid', createdAt: '2024-10-01' },
]
